...
/*   Updated: 2025/03/21 07:10:08 by abelboua         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	button_handle(int button, int x, int y, t_fractol *fractol)
{
	...
	fractol->shifting_x = mouse_re - ((mouse_re - fractol->shifting_x) * fractol->mult_zoom / old_zoom);
	fractol->shifting_y = mouse_im - ((mouse_im - fractol->shifting_y) * fractol->mult_zoom / old_zoom);
	update_fractol_params(fractol);
	return (0);
}
