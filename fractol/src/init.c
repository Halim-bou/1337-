...
/*   Updated: 2025/03/23 18:05:44 by abelboua         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	data_init(t_fractol *fractol)
{
	...
	{
		fractol->julia_x = atof(fractol->julia_params[0]);//todo
		fractol->julia_y = atof(fractol->julia_params[1]);//todo
	}
}
